...
public class HandlerServer {
	...
	public void startRefresh() throws IOException, ResponseRequestException, RequestException {
	...
	public void stopServer() throws IOException, ResponseRequestException, RequestException {
		client.sendRequestResponse(
	...
	public List<Document> getSpigotServerList() throws IOException, ResponseRequestException, RequestException {
		Request request = client.sendRequestResponse(
