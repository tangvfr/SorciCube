...
public class HandlerPlayers {
	...
	public void startUpdatingPlayer(UUID uuid) throws IOException, ResponseRequestException, RequestException {
	...
	public void startSendingPlayer(UUID uuid, String json) throws IOException, ResponseRequestException, RequestException {
		sorci.sendRequestResponse(
	...
	public boolean existPlayer(UUID uuid) throws IOException, ResponseRequestException, RequestException {
	...
	public PlayerFeatures getPlayer(UUID uuid, String pseudo) throws IOException, ResponseRequestException, RequestException, DeckException {
		Request reponse = sorci.sendRequestResponse(
	...
	public void update(PlayerFeatures playerFeature) throws IOException, ResponseRequestException, RequestException {
		sorci.sendRequestResponse(
	...
	public PlayerFeatures initPlayer(UUID uuid, String pseudo, CardFaction faction) throws IOException, ResponseRequestException, RequestException, DeckException {
		Request reponse = sorci.sendRequestResponse(
