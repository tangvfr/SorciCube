...
public class Config extends YamlConfiguration {
	...
	public Config(HandlerConfig handler, String name) throws FileNotFoundException, IOException, InvalidConfigurationException, ResponseRequestException, RequestException {
